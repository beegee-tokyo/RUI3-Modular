...
void setup() 
{
  ...
  Serial.println("RAK12039 PMSA003I Example.");
  Wire.begin();
	
	/*
	 * PMSA003I needs to be warmed up, the values collected in the first 30 seconds are inaccurate, 
	 * so we wait for a while.
	 */
  Serial.println("Sensor warm-up time, need to wait 30s.");
	timeout = millis();
